...
|Merge schema|Automatically update schema of table and make it compatible with the data being written.|False|No|
|Overwrite schema|Automatically overwrite schema of table and make it compatible with the data being written. This option is only available if operation is **overwrite**.|False|NO|
